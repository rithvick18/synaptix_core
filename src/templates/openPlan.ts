...
export const openPlan: Template = {
  ...
  furniture: [
    ...
    { id: 'sofa-base', min: [-4.2, 0, Z0], max: [-1.6, 0.42, Z0 + 1.0], surface: 'fabric', castShadow: true },
    { id: 'sofa-back', min: [-4.2, 0.42, Z0], max: [-1.6, 1.0, Z0 + 0.25], surface: 'fabric', castShadow: true },
    { id: 'sofa-arm-w', min: [-4.2, 0.42, Z0], max: [-3.98, 0.7, Z0 + 1.0], surface: 'fabric', castShadow: true },
    { id: 'sofa-arm-e', min: [-1.82, 0.42, Z0], max: [-1.6, 0.7, Z0 + 1.0], surface: 'fabric', castShadow: true },
    { id: 'sofa-cushion-1', min: [-3.88, 0.42, Z0 + 0.25], max: [-2.95, 0.54, Z0 + 0.97], surface: 'fabric' },
    { id: 'sofa-cushion-2', min: [-2.85, 0.42, Z0 + 0.25], max: [-1.92, 0.54, Z0 + 0.97], surface: 'fabric' },
    ...
    { id: 'mattress', min: [X0 + 0.1, 0.34, -2.66], max: [X0 + 2.24, 0.64, -0.84], surface: 'white', castShadow: true },
    { id: 'duvet', min: [X0 + 0.95, 0.64, -2.66], max: [X0 + 2.24, 0.75, -0.84], surface: 'fabricWarm' },
    { id: 'pillow-1', min: [X0 + 0.16, 0.64, -2.52], max: [X0 + 0.58, 0.78, -1.94], surface: 'white' },
    { id: 'pillow-2', min: [X0 + 0.16, 0.64, -1.64], max: [X0 + 0.58, 0.78, -1.06], surface: 'white' },
    ...
    { id: 'bath-mat', min: [X0 + 2.1, 0, 2.6], max: [X0 + 3.1, 0.014, 3.6], surface: 'fabric' },
